<template>
  <el-dialog title="处理记录" :visible.sync="processingShow" width="40%" :before-close="processingClose">
    <el-table :data="processingData" size='mini' border>
      ...
      <el-table-column prop="optItem" label="处理事项" :formatter="optItem" width="150">
      </el-table-column>
    ...
    <div style="padding: 16px; background: white; overflow: hidden;">
        <div style="float: right;">
          <el-pagination background @current-change="handleCurrentChange" :current-page="paging.currentPage" :page-size="paging.pageSize" layout="total, prev, pager, next, jumper" :total="paging.total">
          </el-pagination>
        </div>
      </div>
  </el-dialog>
